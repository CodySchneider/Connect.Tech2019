...
const stories = storiesOf('Atoms|Disclosure', module);
  ...
  .add(
    ...
    () => (
      <div style={{ marginTop: '50px' }}>
        <Disclosure
          title={text('Section 1 Summary', 'Section 1 Summary')}
          {...props}
        >
          <LoremIpsum />
        </Disclosure>
        <Disclosure
          title={text('Section 2 Summary', 'Section 2 Summary')}
          {...props}
        >
          <LoremIpsum />
        </Disclosure>
        <Disclosure
          title={text('Section 3 Summary', 'Section 3 Summary')}
          {...props}
        >
          <LoremIpsum />
        </Disclosure>
...
stories
  .add(
    'List Theme with No border between Summary/Content when open',
    () => (
      <div style={{ marginTop: '50px' }}>
        <Disclosure
          title="Gray Content Background"
...
stories
  .add(
    ...
    () => (
      <div style={{ marginTop: '50px' }}>
        <Disclosure
          summaryContent={<Button theme="primary">Bohemian Rhapsody</Button>}
          {...props}
        >
          <LoremIpsum />
        </Disclosure>
...
stories
  .add(
    'Programmatic Control of Open Prop',
    () => (
      <div style={{ marginTop: '50px' }}>
        <Disclosure
        ...
        <Disclosure
          title="Bohemian Rhapsody"
          open={boolean('Open State 2', true)}
          {...props}
        >
          <LoremIpsum />
        </Disclosure>
        <Disclosure
          title="Bohemian Rhapsody"
          open={boolean('Open State 3', true)}
          {...props}
        >
          <LoremIpsum />
        </Disclosure>
